    ...
    <ul class="drawer-nav__list">
        @auth
            ...
            <li class="drawer-nav__item">
                {{-- TODO: Request::is の引数は将来的に '' (空文字) にしたい --}}
                <a href="{{ route('home') }}"
                    class="drawer-nav__link{{ Request::is('login') || Request::is('home*') ? ' is-active' : '' }}">
        ...
        @auth
            ...
            <li class="drawer-nav__item">
                <a href="{{ route('user.edit') }}"
                    class="drawer-nav__link{{ Request::is('user*') || Request::is('change_password') ? ' is-active' : '' }}">
