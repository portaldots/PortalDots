...
@section('content')
    <app-container medium>
        <list-view header-title="{{ Auth::user()->is_signed_up ? 'まだユーザー情報の変更は完了していません！' : 'まだユーザー登録は完了していません！' }}">
            <list-view-item>
        ...
        <list-view header-title="確認メールの再送">
            <list-view-item>
        ...
        <list-view header-title="誤った情報でユーザー登録してしまった場合">
