        ...
        <list-view>
            ...
            <list-view-card>
                <ul>
                    ...
                    <li>「お知らせを閲覧可能なユーザー」から「{{ $tag->name }}」タグの指定が解除されます。「{{ $tag->name }}」タグ以外に「お知らせを閲覧可能なユーザー」が設定されていないお知らせは、<strong>全ユーザーが閲覧可能となります</strong>
                    </li>
                    <li>申請フォームの「回答可能な企画のタグ」から「{{ $tag->name }}」タグの指定が解除されます。「{{ $tag->name }}」タグ以外に「回答可能な企画のタグ」が設定されていないフォームは、<strong>企画に所属している全ユーザーが回答可能となります</strong>
                    </li>
                </ul>
            </list-view-card>
