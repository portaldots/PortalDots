...
@section('content')
    <data-grid api-url="{{ route('staff.groups.api') }}" v-bind:key-translations="{
                                ...
                                users: 'メンバー',
                                'users.id': 'ユーザーID',
                                'users.student_id': '{{ config('portal.student_id_name') }}',
                                'users.name_family': '姓',
                                'users.name_family_yomi': '姓(よみ)',
                                'users.name_given': '名',
                                'users.name_given_yomi': '名(よみ)',
                                'users.email': '連絡先メールアドレス',
                                'users.tel': '電話番号',
                                'users.is_staff': 'スタッフ',
                                'users.is_admin': '管理者',
                                'users.email_verified_at': 'メール認証',
                                'users.univemail_verified_at': '本人確認',
                                'users.notes': 'スタッフ用メモ',
                                'users.created_at': '作成日時',
                                'users.updated_at': '更新日時',
                                notes: 'スタッフ用メモ',
                                created_at: '作成日時',
                                updated_at: '更新日時',
                            }">
