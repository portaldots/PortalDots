...
ssh ${SSH_USERNAME}@${SSH_HOST} -o StrictHostKeyChecking=no "cd /home/${SSH_USERNAME}/${DEPLOY_DIRECTORY}/; php artisan config:cache; php artisan route:cache; php artisan view:clear; php artisan migrate --force; chmod 755 application/uploads/documents; chmod 755 application/uploads/form_file" >& /dev/null
echo "デプロイ End"
