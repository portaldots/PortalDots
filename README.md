...
- **[最新バージョンをダウンロード](https://releases.portaldots.com/downloads/latest.zip?major_version=3)**
...
1. PortalDots をダウンロードします。 **[ここをクリックすると最新バージョンをダウンロードできます](https://releases.portaldots.com/downloads/latest.zip?major_version=3)**
