<?php
	...
	$this->set_js_config($this->default_theme_path.'/crud-bootstrap/js/crud-bootstrap-add.js');
...
<div class="panel-footer">
		<input id="form-button-save" type='submit' value='<?php echo $this->l('form_save'); ?>'  class="btn btn-primary btn-lg"/>
<?php 	if(!$this->unset_back_to_list) { ?>
		<input type='button' value='<?php echo $this->l('form_save_and_go_back'); ?>' id="save-and-go-back-button"  class="btn btn-default btn-lg"/>
