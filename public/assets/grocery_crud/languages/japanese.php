...
/* Translated by: Kenta Saito */
    ...
    $lang['list_export'] 	= "CSV形式で出力"; // タブ区切りのCSV(character-separated values)ファイル
    $lang['list_print'] 	= "印刷";
